...
* Ouvrez dans Firefox le fichier spaceinvaders.test.html pour voir les test unitaires s'exécuter.
* Ouvrez dans Firefox le fichier spaceinvaders.html pour voir la réalité de votre implémentation !
