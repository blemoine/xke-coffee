...
* Ouvrez dans un navigateur récent (sauf chrome) le fichier spaceinvaders.test.html pour voir les test unitaires s'exécuter.
* Ouvrez dans un navigateur récent (sauf chrome) le fichier spaceinvaders.html pour voir la réalité de votre implémentation !
